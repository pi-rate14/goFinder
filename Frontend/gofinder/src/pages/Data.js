    ...
    'EuroSMC S.A.': [
      {
        ...
        'Linkedin Profile': 'linkedin.com/in/christa-langner-9a6a3965',
      ...
      },
      {
        ...
        Position: 'CEO',
        'Linkedin Profile': 'linkedin.com/in/eduardo-marchesi-47527511',
        location: 'Greater Madrid Metropolitan Area',
        allSkills:
    ...
    'Sintex a/s': [
      {
        ...
        'Linkedin Profile':
          'https://www.linkedin.com/in/thomas-soerensen-54b86a9/',
      },
    ],
  },
  Textile: {
    'White Cross Rubber Products': [
      {
        ...
        allSkills: '',
        'Linkedin Profile': 'https://www.linkedin.com/in/paul-graham-445a5047/',
      },
      {
        Name: 'Philip Harper',
        imgUrl:
        ...
        allSkills: '',
        'Linkedin Profile':
          'https://www.linkedin.com/in/philip-harper-961b313/',
      },
    ],
    'Textiles Industry Affairs': [
      {
        ...
        allSkills: '',
        'Linkedin Profile':
          'https://www.linkedin.com/in/bhavesh-jain-4271a6bb/',
      },
    ],
  },
  Pharmaceutical: {
    'Pharmaceutical Industry': [
      {
        ...
        allSkills: '',
        'Linkedin Profile':
          'https://www.linkedin.com/in/kate-williams-35901719a/',
      },
    ],
    'Pharmaceutical Industry Association': [
      {
        ...
        Position: 'General Manager',
        'Linkedin Profile': 'https://www.linkedin.com/in/priscilla-b-684526/',
      },
    ],
  },
  ...
  'IT and Services': {
    IBM: [
      ...
      },
      {
        ...
        'Linkedin Profile':
          'https://www.linkedin.com/in/kunal-bajaj-79294b182/',
        allSkills: '',
      },
    ],
  },
    ...
    Bayer: [
      {
        ...
        'Linkedin Profile':
          'https://www.linkedin.com/in/klaus-eckstein-b8396897//',
        allSkills: '',
      },
      {
    ...
    BASF: [
      {
        ...
        allSkills:
          'Business Strategy, Management, Leadership, Business Planning',
        'Linkedin Profile': 'https://www.linkedin.com/in/andreas-l-b147219/',
      },
      {
        Name: 'Kevin Levey',
        imgUrl:
        ...
        'Linkedin Profile': 'https://www.linkedin.com/in/kevin-levey-478aa365/',
      },
    ],
  },
  Automobile: {
    'Daimler AG': [
      ...
      },
      {
        ...
        'Linkedin Profile':
          'https://www.linkedin.com/in/peter-gierse-1a335311/',
      },
      {
        Name: 'Amit Sharma',
        allSkills:
        ...
        location: 'India',
        Position: 'Head of Procurement',
        'Linkedin Profile': 'https://www.linkedin.com/in/amitsharma28/',
      },
    ],
    'Lear Corporation': [
      {
        ...
        allSkills: '',
        'Linkedin Profile': 'https://www.linkedin.com/in/manikandanthirumeni/',
      },
      {
        Name: 'Deepak Tiwar',
        imgUrl:
        ...
        'Linkedin Profile':
          'https://www.linkedin.com/in/deepak-tiwari-b6707471/',
      },
    ],
  },
}
